...
import com.example.administrator.beijingnews.adapter.TopicTopNewsPagerAdapter;
...
public class TopicTabDetailPager extends MenuDetailBasePager {
    ...
    public TopicTabDetailPager(Context mContext, NewsCenterPagerBean.DataBean.ChildrenBean childrenBean) {
        super(mContext);
    ...
    public View initView() {
        ...
        x.view().inject(TopicTabDetailPager.this, headView);

        mPullRefreshListView = (PullToRefreshListView) view.findViewById(R.id.pull_refresh_list);
        lvNewsDetail = mPullRefreshListView.getRefreshableView();
/**
...
//                lvNewsDetail.onRefreshFinished(false);
    ...
    private void processData(String jsonData) {
        ...
        if (!isLoadMore) {
            ...
            vpNewsTitleImage.setAdapter(new TopicTopNewsPagerAdapter(topImageNewsData, mContext));
